...
module.exports.handleEvent = async function ({ api, event }) {
  try {
    ...
    const triggerWords = ["baby", "bby", "bot", "বট", "Sumon", "জান", "jan", "beby", "bobi", "babby"];
